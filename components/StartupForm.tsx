    ...
    return (
        <form action={formAction} className="startup-form">
            ...
            <div>
                ...
                <Input id="category" name="category" className="startup-form_input" required placeholder="Startup Category (e.g., Tech, Health, Education, etc.)"/>
            ...
            <div data-color-mode="light">
                ...
                <MarkdownEditor value={pitch} onChange={(value)=>setPitch(value)} id="pitch" height="300px" style={{borderRadius:20, overflow:"hidden"}} placeholder="Briefly describe your idea and what problem it solves" previewProps={{disallowedElements:['style']}} editable={true}/>
